...
export default function Home() {
  ...
  const handleSync = async (quiet = false) => {
    ...
    try {
      ...
      console.error(error);
      if (!quiet) setSyncStatus(`Sync error: ${error.message || "Failed to reach backend"}`);
    } finally {
        ...
        {!user ? (
          ...
          <div style={styles.heroCard}>
            ...
            <p style={styles.heroSubtitle}>
              Connect your GitHub account, authorize the CyberSuite security scanner, and monitor your repositories for vulnerabilities.
            </p>
            <a
          ...
          <div style={styles.dashboardGrid}>
            ...
            <div style={styles.card}>
              ...
              {syncStatus && (
                <div style={syncStatus.includes("successfully") ? styles.statusSuccess : styles.statusInfo}>
                  {syncStatus}
                </div>
              )}
            </div>
              ...
              {repos.length === 0 ? (
                <div style={styles.emptyState}>
                  ...
                  <p style={{ fontSize: "14px", opacity: 0.6 }}>
                    Install the GitHub App and click "Sync Repositories" to bring your code repositories here for scanning.
                  </p>
                </div>
              ) : (
