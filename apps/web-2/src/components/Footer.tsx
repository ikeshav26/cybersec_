      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between gap-12 text-left">
        ...
        <div className="flex flex-col justify-start max-w-xs">
          ...
          <p className="text-xs text-neutral-500 leading-relaxed">
            AI-powered DevSecOps platform automatically securing GitHub codebases on every commit.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-8 md:gap-16">
          <div>
            ...
            <ul className="flex flex-col gap-2.5 text-xs">
              <li><Link to="/" className="hover:text-white transition-colors duration-200">Security Scan</Link></li>
              <li><Link to="/" className="hover:text-white transition-colors duration-200">AI Remediation</Link></li>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-2.5 text-xs">
              <li><a href="https://docs.aegis.dev" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors duration-200">Documentation</a></li>
              <li><Link to="/about" className="hover:text-white transition-colors duration-200">About Us</Link></li>
              <li><Link to="/dashboard" className="hover:text-white transition-colors duration-200">Workspace</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-2.5 text-xs">
              <li><a href="https://github.com" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors duration-200">GitHub App</a></li>
              <li><a href="https://github.com" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors duration-200">Open Source</a></li>
            </ul>
          </div>
