...
// Inline SVG logo as a data URI so CardNav's <img> renders the "aegis" wordmark
const LOGO_SRC =
...
const Navbar = () => {
  return (
    // Outer wrapper: positions the CardNav fixed at top, adds backdrop-blur
    <div className="fixed top-0 left-0 right-0 z-50 w-full pointer-events-none">
      <CardNav
        ...
        // backdrop-blur applied via className on the container div inside CardNav
